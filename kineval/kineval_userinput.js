...
*/
    ...
    if (kineval.params.update_pd||kineval.params.persist_pd) {
        ...
        if (kineval.params.update_pd_dance)
            textbar.innerHTML += "<br>executing Thriller Zombie walk, pose " + kineval.params.dance_pose_index + " of " + kineval.params.dance_sequence_index.length;
    }
...
kineval.changeActiveLinkDown = function change_active_link_down() {
  ...
  (robot.links[robot.joints[kineval.params.active_joint].child].children.length != 0) ) {
