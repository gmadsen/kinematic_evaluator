...
function startingPlaceholderAnimate() {
    ...
    global_spacing -=.1;
        ...
        textbar.innerHTML = "We all float down here. You'll float, too.";  // set message text
        vert_offset = 1;
        jitter_radius = 0.2;
    }
    ...
    // jsmat is the matrix data structure used to separately transform each 3D object to
    //a specific location in the world
    // we will represent matrices with index notation, such that matrix[row][column] indexes
